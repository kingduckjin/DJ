...
// 대상 문자열이 검색문자열 (searchString)로 시작(startWith)하거나
// 끝(endWith)나는지 여부 반환  (true / false)
...
console.log(str.endsWith('String'));     //ture
console.log(str.includes('of'));         //ture
console.log('━━━━━━━━━━━━━━━━━━━━━━━')

//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

// 배열 연산자와 charAt은 기능상 동일하지만, 
// 배열 연산자는 해당 인덱스에 문자가
// 존재하지 않으면 undefined를 반환하는 반면
// charAt는 빈 문자열(' ')를 반환
console.log(str[50]);
...
// substring은 인덱스를 지정해 해당 위치의 부분 문자열을 반환받는 반면, indexOf는 문자열을 지정해
// 검색되는 문자열의 최초 해당 인덱스를 반환.검색 시작 위치(position)를 추가로 지정 가능하며
// 검색 실패시 - 1 반환. 단, 최초 검색되는 문자열에 대응되는 인덱스만 반환할 뿐 매칭된
// 모든 문자열의 인덱스를 반환하는 것은 아님에 주의.
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// lastindexOf(searchString:string,position?:number ):number
// indexOf와 기능상 돌일하되 역순 검색.
...
// 단, 연산 우선 순위에 주의.
// 대입(할당) 연산자(=) 보다 비교 연산자(!=)가 우선 순위가 더 높아
// 할당 연산(ix = str.indexOf('t', ix + 1))을 먼저하지 않으면,
// 비교 연산(str.indexOf('t', ix + 1)) != -1 )이 우선 적용되어
// 검색되는 값이 존재하면 대입되지 않고 루프로 바로 진입되어 무한 루프 발생 가능.
...
// js에서의 모든 문자열은 UTF - 16형식으로 인코딩. (구버젼 메서드 - charCodeAt)
...
// ※ 서로게이트 쌍: 2바이트로 표현되는 유니코드의 범위의 한계로 인해 사용빈도가 낮은 
// 특수 문자들에 대하여 2바이트 쌍(4byte)으로 인코딩하여 표현.
